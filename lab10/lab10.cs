...
namespace DFA
{
    class Program
    {
        ...
        static void Print_Stack(Stack<string> stack)
        {
        ...
        static void Main(string[] args)
        {
            ...
            dict.Add("S21", new Dictionary<String, object>()
            {
                { "begin", "" },
                { "(", "" },
                { ")", "" },
            ...
            dict.Add("S22", new Dictionary<String, object>()
            {
                { "begin", "" },
                { "(", "" },
                { ")", "" },
            ...
            while (true)
            {
                ...
                {
                    Output.Append("Unable to Parse Unknown Input");
                    break;
                }
